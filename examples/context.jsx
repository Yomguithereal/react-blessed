  ...
  render() {
    ...
    return (
      <box label="react-blessed context demo"
        ...
        <button border={{type: 'line'}} height={3} width={3} top={2} left={4} onPress={a => console.error('press', a)}>+</button>
        <button border={{type: 'line'}} height={3} width={3} top={2} onPress={a => console.error('press', a)}>-</button>
      </box>
    );
  }
}
